...
public class UserAccountPage extends BasePage<UserAccountPage> {
    ...
    private static final String MY_ACCOUNT_SETTING = "//*[@class='nav item'][4]/a";
    ...
    private static final String SAVE_CHANGE_BUTTON = "//div[@class='account-edit']/div[3]/button";
    private static final String SUCCESS_MESSAGE ="//div[@data-ui-id='message-success']";
    ...
    public UserAccountPage clickMyAccountSetting() {
        waitElementToBeClickable(By.xpath(MY_ACCOUNT_SETTING)).click();
        return this;
    }

    @Step("Enter new user name")
    public UserAccountPage enterNewUserName(String name) {
    ...
    public UserAccountPage enterNewUserSurname(String surname) {

...
import static pages.ProductPage.ProductInfo.*;
import static pages.ShoppingCardPage.ProductInfo.*;
...
public class ShoppingCardTest extends BaseTest {
    ...
    public void addDeleteAndUpdateQuantity() {
        ...
        Assert.assertEquals(nameProductInHomePage, productPage.getTextFromLocator(NAME_PRODUCT), "Product name in cart does not match product on homepage.");

        productPage
                .clickOnAddToShoppingCardButton()
                .clickOnSelectedSizeButton();

        Assert.assertEquals(nameProductInHomePage, productPage.getTextFromLocator(PRODUCT_NAME_IN_CARD_PREVIEW), "Product name in cart preview does not match product on homepage.");

        String sizeProduct = productPage.getTextFromLocator(PRODUCT_SIZE_IN_POP_UP_REVIEW_SHOPPING_CARD);

        productPage
                .clickOnTheAddToShoppingCardButtonInPopUp();
        ...
        shoppingCardPage.clickOnTheAddOneProductButton();
        ...
        shoppingCardPage.clickOnTheDeleteFromShoppingCardButton()
                .clickAcceptToDeleteProductFromShoppingCardButton();
